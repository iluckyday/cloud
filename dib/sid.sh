...
sed -i -e '/gnupg/d' -e 's/python3//' "$PY_DIB_PATH"/elements/debian-minimal/root.d/75-debian-minimal-baseinstall
sed -i 's/python//' "$PY_DIB_PATH"/elements/debian-minimal/root.d/75-debian-minimal-baseinstall
