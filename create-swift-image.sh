...
apt install -y -o APT::Install-Recommends=0 -o APT::Install-Suggests=0 xfsprogs memcached swift swift-proxy swift-account swift-container swift-object python3-swiftclient
...
qemu-img convert -c -f raw -O qcow2 /tmp/sid.raw /tmp/swift.img
